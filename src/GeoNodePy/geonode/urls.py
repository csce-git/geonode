...
urlpatterns = patterns('',
    ...
    url(r'^groups/$', 'geonode.groups.views.group_list', name="group_list"),
    url(r'^groups/group/(?P<slug>[-\w]+)/$', 'geonode.groups.views.group_detail', name='group_detail'),
    url(r'^groups/group/(?P<slug>[-\w]+)/members/$', 'geonode.groups.views.group_members', name='group_members'),
    url(r'^groups/group/(?P<slug>[-\w]+)/invite/$', 'geonode.groups.views.group_invite', name='group_invite'),
    url(r'^groups/group/[-\w]+/invite/(?P<token>[\w]{40})/$', 'geonode.groups.views.group_invite_response', name='group_invite_response'),
